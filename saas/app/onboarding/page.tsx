...
const steps = [
  ...
  { icon: Sparkles, title: 'AI does the rest', description: 'InstaFlow sends personalized DMs and tracks every result.' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-pink-50 flex items-center justify-center p-6">
      <div className="max-w-2xl w-full">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-gray-900 mb-3">Welcome to InstaFlow!</h1>
